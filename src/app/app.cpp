...
void App::renderChangelog() {
    ...
    std::vector<std::string> lines = {
        "Zv1 Infinite Depths - ASCII Art Edition",
        "",
        "Added:",
        "  - 150+ items: 159 templates weapons armor potions food scrolls guide fragments lore",
        "  - 80+ monsters: 85 templates 50 new enemies + 8 new bosses + shopkeeper + mimics",
        "  - Infinite depth beyond 30 with scaling (+power per depth, maps grow to 200x200)",
        "  - Huge maps 160x80 with viewport camera 80x24",
        "  - Biomes: Stone Fungal Crystal Infernal Abyssal Flooded Frozen Ruins Void",
        "  - TUI borders with ASCII art boxes, colors for HP Lv XP Atk Def Gold Rubies",
        "  - Hunger/saturation: hunger drains, saturation heals HP, starving damages",
        "  - Guide fragments collectible unlocking codex guides",
        "  - Lore scrolls and boss lore drops with cutscenes",
        "  - Side inventory panel, top/bottom info, improved layout",
        "  - ASCII Art Library: custom lib handles colors resize terminal drawing",
        "  - Sprites for all monsters/items using colored ASCII letters only, no emojis",
        "  - Bestiary shows all 85 monsters with sprites stats depth",
        "  - Shop rooms: random room becomes shop with shopkeeper and guard, buy with gold o",
        "  - Mimics: chest tiles 25% are mimics, disguised until approached",
        ...
        "  - 4 Windows artifacts: x86_64 x86 arm64 arm32",
        "",
        "Changed:",
        "  - Map size from 80x24 to 160x80 viewport 80x24",
        "  - Max depth from 30 to 200 win at 30 still infinite beyond",
        "  - Help menu essentials only + shop altar fountain minimap keys",
        "  - Food system expanded with bread meat rations fruit cheese jerky soup feast",
        "  - Rendering uses ASCII art library drawSprite drawBoxStyled drawProgressBar",
        "  - No emojis anywhere only colored ASCII letters for glyphs",
        "",
        "Fixed:",
        "  - Windows build: missing cstdint in guide_codex and 6 other headers",
        "  - Windows 4 arch matrix: x86_64 x86 arm64 arm32 all success",
        "  - ASCII art Wconversion warnings fixed",
        "  - Bestiary tab count %5 for 5 tabs",
        "  - Release workflow tag Zv1 now publishes all artifacts",
        "",
        "Press any key to return"
    };
