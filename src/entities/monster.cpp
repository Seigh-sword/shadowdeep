...
const std::vector<MonsterTemplate>& allMonsterTemplates() {
    static std::vector<MonsterTemplate> templates = {
        ...
        {"monster.mimic", "mimic", 'M', "", Color::Brown, MonsterFamily::Aberration, 35, 10, 10, 5, 70, 4, 12, 90, false, false, false, DamageType::Physical, {}},
        {"monster.chest_mimic", "chest mimic", 'C', "", Color::Gold, MonsterFamily::Aberration, 45, 12, 12, 6, 90, 5, 14, 80, false, false, false, DamageType::Physical, {}},
        {"monster.shopkeeper", "shopkeeper", 'S', "", Color::BrightYellow, MonsterFamily::Humanoid, 120, 20, 20, 10, 0, 10, 99, 100, false, true, false, DamageType::Physical, {}},
        {"monster.shop_guard", "shop guard", 'K', "", Color::Steel, MonsterFamily::Humanoid, 90, 18, 16, 8, 0, 8, 20, 100, false, true, false, DamageType::Physical, {}},
